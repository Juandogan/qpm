...
@Component({
  selector: 'app-loadig-image2',
  templateUrl: './loadig-image2.component.html',
  styleUrls: ['./loadig-image2.component.css']
})
export class LoadigImage2Component implements OnInit {
